...
function HomeProductKoinworks(props) {
  ...
  return (
    <div className="container-fluid">
      <div className=" kw-home-product-koinworks">
        <Row>
          <Col lg={24}>
            <h3 className="kw-home-product-koinworks__heading-text">
              {t(
                "homeLanguage:homeProductKoinworks.homeProductKoinworksHeading"
              )}
            </h3>
          ...
          <Col xs={24} sm={8} lg={6}>
            <h4>
              {t(
                "homeLanguage:homeProductKoinworks.homeProductKoinworksWealth"
              )}
            </h4>
