    ...
    <Row>
      <Col lg={24}>
        <div className="container">
          <div className="kw-home-financial-choices">
            <Row>
              <Col md={12} lg={12}>
                <img
            ...
            <Row>
              ...
              <Col xs={24} lg={6}>
                ...
                <p>
                  {t(
                    "homeLanguage:homeFinancialChoices.homeFinancialDescriptionTwo"
                  )}
                </p>
              </Col>
              <Col xs={24} lg={6}>
                <h4>
                  {t("homeLanguage:homeFinancialChoices.homeFinancialLabelTwo")}
                </h4>
                <p>
                  {t(
                    "homeLanguage:homeFinancialChoices.homeFinancialDescriptionThree"
                  )}
                </p>
              </Col>
              <Col xs={24} lg={6}>
                <h4>
                  {t(
                    "homeLanguage:homeFinancialChoices.homeFinancialLabelThree"
                  )}
                </h4>
                <p>
                  {t(
                    "homeLanguage:homeFinancialChoices.homeFinancialDescriptionFour"
                  )}
                </p>
              </Col>
            </Row>
