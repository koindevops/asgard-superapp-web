...
function KoinP2pHowWorks(props) {
  ...
  return (
    <div className="container-fluid kw-koinp2p-how-works-wrapper">
      ...
      <Row>
        ...
        <Col md={8}>
          ...
          <h4>KoinWorks</h4>
          <p>
            {t("koinp2p:koinp2p.koinp2p-content-how-koinp2p-company-koinworks")}
          </p>
        </Col>
        <Col md={8}>
          <img
            ...
            className="kw-koinp2p-how-works-wrapper__image-hidden-xs"
          />
          <h4>{t("koinp2p:koinp2p.koinp2p-content-how-koinp2p-borrowers")}</h4>
          <p>
            {t(
